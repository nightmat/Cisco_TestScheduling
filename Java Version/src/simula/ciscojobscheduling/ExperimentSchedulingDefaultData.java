...
public class ExperimentSchedulingDefaultData {
	...
	static int jobsMax = 2000;	//maximum jobs you want to execute
	...
	public static void main(String[] args) throws Exception {
		...
		ExperimentSchedulingDefaultData ex = new ExperimentSchedulingDefaultData();
		ex.initi();
		ex.getValues_1();
		file.close();
	...
	public void initi() {
		...
		dataGenerator.generateJobs(jobsMax, 1, 13000);
		dataGenerator.generateResources(300, 1, 900);
		dataGenerator.setJobResource(5);
